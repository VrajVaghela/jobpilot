...
export function ProfileForm({ initialData, onChange, onSave }: ProfileFormProps) {
    ...
    <div className="rounded-xl border border-border bg-surface p-6 shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]">
      ...
      >
        ...
        <div className="pt-4">
          <button
            type="submit"
            className="w-full rounded-md bg-accent px-4 py-3 text-sm font-semibold text-accent-foreground transition-opacity hover:opacity-90 shadow-sm"
          >
            Save Profile
          </button>
        </div>
